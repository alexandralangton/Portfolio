...
const projectList = [
	...
	},
	{
		...
		description:
			'A mock ecommerce website selling hair products, created by myself and two other pun-loving developers as part of The Grace Hopper program. Beneath the whimsical images and humorous product categories lies a fully functional site, featuring Etsy-inspired stock-checks when a user checks out, and a secured admin dashboard to replenish stock and add new products. I tackled vertical slices of the site including the cart and a secured admin dashboard.',
		techStack:
	...
	},
	{
		...
		link2: null,
		link2URL: null,
		description: `Meta, I know. This portfolio was designed and built from scratch by myself, with no boilerplate starter code, design templates or style libraries used. The site was built with React, using functional components and hooks. If you'd like to have a look at the source code, you can see this on my GitHub!`,
